...
public class ProfileController {
   ...
   @PostMapping("/payment")
    ...
    public String handleAccept(@RequestParam("OutSum") String OutSum,
        ...
        balanceTransactionService.updateAcceptTransaction(InvId, BalanceTransaction.TypeStatus.OK, description, OutSum);
    ...
    public String handleFail(@RequestParam("OutSum") String OutSum,
        ...
        balanceTransactionService.updateAcceptTransaction(InvId, BalanceTransaction.TypeStatus.FAIL, description, OutSum);
        return "redirect:http://localhost:8085/profile";
    }
