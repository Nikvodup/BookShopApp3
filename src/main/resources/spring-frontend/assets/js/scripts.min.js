                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'genre':
                                ...
                                break;
                            case'genreType':
                                getData('/books/genreType/' + $this.data('refreshid'), {
                                    offset: function() {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset >= 1) {
                                            oldOffset = oldOffset - $this.data('refreshlimit');
            ...
            return {
                init: function () {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/changeBookStatus/review/' + $this.data('bookid'), {
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            ...
                                            case'popular':
                                                ...
                                                break;
                                            case'recently_views':
                                                sendData('/books/recently_views')
                                                break;
                                            case 'author':
                                                sendData('/books/author/page/' +  $this.data('refreshquery'))
                                                break;
                                        }
                                    }
                                }
